...
SYSTEM_MESSAGE = """You are generating a comprehensive educational document. Write a complete, well-structured document of approximately 4000-5000 words. You MUST complete the entire document with a proper conclusion. Plan your structure so every section is fully developed and the document ends with a complete closing. Do not leave any section unfinished."""
