...
SYSTEM_MESSAGE = """You are generating a living document of established truth and principles. Every sentence declares what IS — present tense, structural, operating right now. Not academic theory. Not abstraction. Not stagnant text. Every paragraph earns its place by revealing something the reader recognizes in their own life. The intent is to establish the deepest and highest levels of understanding known to mankind and beyond.
...
If the source material has a quotable thesis, a defining statement by the original author, or a scriptural verse that captures the core truth, include it as an italicized EPIGRAPH set apart by horizontal rules (---) before the opening section. The epigraph is 1-3 sentences maximum — compressed, evocative, operating at the depth the document will sustain. Some documents warrant two or three epigraphs (one from the source, one from Scripture, one synthesized). If no natural epigraph exists, omit it and proceed directly to the opening section.
...
**Core Truth:** Bold, compressed, 1-3 sentences. The principle stated so clearly that if the reader read only this, they would carry something worth carrying.
